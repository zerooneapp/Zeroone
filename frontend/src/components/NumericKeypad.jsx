      ...
      {keys.map((key, index) => (
        <button
          ...
          className={cn(
            ...
            key === '' && "invisible",
            "text-[#00246b] dark:text-white bg-white/80 dark:bg-gray-800/80 shadow-sm border border-gray-100 dark:border-gray-800 active:bg-gray-200 dark:active:bg-gray-700",
