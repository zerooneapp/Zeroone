...
const WithdrawModal = ({ isOpen, onClose, balance, minWithdrawal, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-950 rounded-3xl w-full max-w-md overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200 border border-gray-100 dark:border-gray-800">
        <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gradient-to-r from-[#00246b]/5 to-[#00246b]/10 dark:from-white/5 dark:to-white/10">
          <div>
            <h2 className="text-xl font-bold text-[#00246b] dark:text-white">Withdraw Funds</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-[#00246b]/20 dark:focus:ring-white/10 focus:border-[#00246b] dark:focus:border-white text-gray-900 dark:text-white outline-none transition-all"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Withdrawal Method</label>
          ...
          {method === 'upi' ? (
            <div className="space-y-4 animate-in slide-in-from-top-2 duration-200">
              <div>
                <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1.5 ml-1">UPI ID</label>
                <input
                  type="text"
                  required
                  value={upiDetails.upiId}
                  onChange={(e) => setUpiDetails({ upiId: e.target.value })}
                  className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl outline-none focus:ring-2 focus:ring-[#00246b]/20 dark:focus:ring-white/10 focus:border-[#00246b] dark:focus:border-white text-gray-900 dark:text-white"
            ...
            <div className="space-y-4 animate-in slide-in-from-top-2 duration-200">
              <div className="grid grid-cols-2 gap-3">
                <div className="col-span-2">
                  <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1.5 ml-1">Account Holder Name</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1.5 ml-1">Bank Name</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1.5 ml-1">IFSC Code</label>
                  <input
                    type="text"
                    required
                    maxLength={11}
                ...
                <div className="col-span-2">
                  <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1.5 ml-1">Account Number</label>
                  <input
                    type="text"
                    required
                    maxLength={18}
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-[#00246b] hover:bg-[#001b50] disabled:bg-gray-400 text-white font-bold rounded-2xl shadow-lg shadow-[#00246b]/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
            >
              {loading ? (
