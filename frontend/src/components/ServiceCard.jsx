...
const ServiceCard = ({ service, onToggle, onEdit, onSetHome, homeLoadingId }) => {
   ...
   return (
      <motion.div
         ...
         className={`p-2.5 bg-white dark:bg-gray-900/40 rounded-2xl border border-[#00246b]/10 dark:border-gray-800 shadow-sm flex items-center gap-2 transition-opacity active:scale-[0.98] w-full min-w-0 overflow-hidden`}
      >
         ...
         <div className="flex flex-col gap-1.5 items-end flex-shrink-0">
            ...
            <button
               ...
               className={`w-10 h-5 rounded-full relative transition-all duration-300 border ${service.isActive ? 'bg-[#00246b] border-[#00246b]' : 'bg-red-600 border-red-700'}`}
            >
