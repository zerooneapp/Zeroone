...
const Header = ({ onOpenNotifications }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-950/95 backdrop-blur-2xl px-4 pt-12 pb-2 border-b border-slate-100 dark:border-gray-800 shadow-sm">
