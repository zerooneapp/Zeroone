...
const Header = ({ onOpenNotifications }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-950/95 backdrop-blur-2xl px-4 pt-[46px] md:pt-3 pb-2 md:pb-2.5 border-b border-slate-100 dark:border-gray-800 shadow-sm">
