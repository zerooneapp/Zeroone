        ...
        <nav className="flex-1 px-4 mt-4 space-y-1 overflow-y-auto no-scrollbar">
          {adminRoutes.map((route) => (
            ...
            >
              {({ isActive }) => (
                <>
                  <route.icon size={22} className={cn("transition-colors", isActive ? "text-primary dark:text-white" : "text-gray-400 dark:text-slate-400", "group-hover:text-primary dark:group-hover:text-white")} />
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <div className="text-right">
                <p className="text-sm font-black dark:text-white capitalize group-hover:text-primary dark:group-hover:text-white transition-colors">{currentAdmin?.name || 'Admin'}</p>
