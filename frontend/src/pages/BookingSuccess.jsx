   ...
   return (
      <div className="min-h-[88vh] flex flex-col items-center justify-center px-4 animate-in fade-in duration-700 pb-16">
         ...
         <div className="text-center space-y-1 mb-6">
            ...
            <p className="text-[9px] text-slate-400 font-black tracking-widest leading-none mt-1 uppercase">Your appointment is scheduled successfully.</p>
         </div>
         ...
         >
            ...
            <div className="p-4 px-4 space-y-3.5">
         ...
         <div className="w-full max-w-sm space-y-2">
            ...
            <button
               onClick={() => navigate('/')}
               className="w-full h-11 bg-slate-50 dark:bg-gray-800/80 text-slate-500 rounded-xl flex items-center justify-center gap-2 font-black text-[9px] tracking-widest border border-slate-100 dark:border-gray-700 active:scale-95 transition-all shadow-sm uppercase"
            >
               <Home size={14} />
               Back to home
            </button>
