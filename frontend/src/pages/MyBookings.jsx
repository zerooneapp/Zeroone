...
const MyBookings = () => {
  ...
  if (loading) return (
    <div className="p-5 space-y-6 pt-[calc(var(--safe-header-top)+90px)]">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background-light dark:bg-gray-950 overflow-hidden">
      <header className="fixed top-0 left-0 right-0 z-50 px-4 pt-[var(--safe-header-top)] pb-2 bg-white/95 dark:bg-gray-950/95 backdrop-blur-xl border-b border-slate-100 dark:border-gray-800 shadow-sm shrink-0">
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar scroll-smooth px-4 pt-[calc(var(--safe-header-top)+98px)] pb-24">
            ...
            {paginatedBookings.map((booking) => (
              ...
              >
                <div className="flex justify-between items-start mb-2 leading-none">
                  <div>
                    <h3 className="font-black text-[15px] text-gray-900 dark:text-white truncate max-w-[200px] tracking-tight">{booking.vendorId?.shopName || 'Partner'}</h3>
                    <div className="flex items-center gap-1 text-[9px] font-bold text-slate-400 dark:text-gray-400 tracking-tight mt-1.5">
                      ...
                      <span className="line-clamp-1">{booking.vendorId?.address || 'Partner location'}</span>
                    </div>
                  </div>
            ...
            {totalPages > 1 && (
              <div className="pt-6 flex items-center justify-center gap-4">
                <button
                  ...
                  className="w-10 h-10 rounded-xl bg-white dark:bg-gray-900 border border-slate-100 dark:border-gray-800 flex items-center justify-center text-slate-400 disabled:opacity-30 active:scale-90 transition-all shadow-sm"
                >
