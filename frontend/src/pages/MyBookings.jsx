...
const MyBookings = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark pb-32 bg-white dark:bg-gray-950">
      <header className="px-4 pt-6 pb-2 sticky top-0 bg-white/95 dark:bg-gray-950/95 backdrop-blur-2xl z-40 border-b border-gray-50 dark:border-gray-900/50">
        <div className="flex items-center gap-3">
          <button 
            onClick={() => navigate(-1)}
            className="p-1 -ml-1 text-[#1C2C4E] dark:text-blue-400"
          >
          ...
          {['upcoming', 'completed', 'cancelled'].map(tab => {
            ...
            return (
              <button
                ...
                className={`flex-1 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-widest border-2 ${
                  isActive 
                  ? 'bg-[#1C2C4E] border-[#1C2C4E] text-white shadow-xl shadow-[#1C2C4E]/20' 
        ...
        {filteredBookings.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredBookings.map((booking) => (
              <div 
                key={booking._id} 
                className="bg-white dark:bg-gray-900 p-4 rounded-[2rem] border border-gray-50 dark:border-gray-800 shadow-sm transition-all"
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 py-3 border-y border-dashed border-gray-100 dark:border-gray-800 mb-3">
