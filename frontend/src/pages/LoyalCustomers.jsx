...
const LoyalCustomers = () => {
  ...
  if (isStaff) {
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-gray-950 flex flex-col">
        ...
        <header className="fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-slate-100 dark:border-gray-800 px-4 pt-[var(--safe-header-top)] pb-3 flex items-center justify-between gap-4">
        ...
        {/* Main Body */}
        <main className={`p-4 overflow-y-auto flex-1 space-y-4 pb-24 ${historyProducts.length > 0 ? 'pt-4' : 'pt-[var(--safe-main-top)]'}`}>
          {historyLoading ? (
  ...
  if ((queryPhone || queryCustomerId) && !selectedCustomer && loading) {
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
        <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-slate-100 dark:border-gray-800 px-4 pt-[var(--safe-header-top)] pb-3 flex items-center gap-4">
          <button 
            onClick={() => {
              if (queryCustomerId) {
                navigate(-1);
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-950 pb-20">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-slate-100 dark:border-gray-800 px-4 pt-[var(--safe-header-top)] pb-3 flex items-center gap-4">
        <button 
      ...
      <main className="pt-[var(--safe-main-top)] px-4 space-y-4">
        {/* Search & Filter */}
        <div className="space-y-3">
        ...
        {isHistoryOpen && selectedCustomer && (
          ...
          >
            <div className="w-full max-w-4xl mx-auto h-full flex flex-col bg-white dark:bg-gray-900">
              <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-slate-100 dark:border-gray-800 px-4 pt-[var(--safe-header-top)] pb-3 flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <button 
                    onClick={() => {
                      setIsHistoryOpen(false);
