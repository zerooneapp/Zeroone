...
const BookingStatusDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-gray-950 pb-32">
      <header className="px-2.5 pt-[var(--safe-header-top)] pb-3 flex items-center justify-between sticky top-0 bg-background-light/95 dark:bg-gray-950/95 backdrop-blur-xl z-50 border-b border-slate-100 dark:border-gray-800 shadow-sm">
        ...
        <section className="bg-white dark:bg-gray-900 p-4 rounded-2xl border border-[#00246b]/10 dark:border-gray-800 shadow-sm space-y-3.5">
          ...
          <div className="pt-2.5 border-t border-slate-50 dark:border-gray-800 space-y-2">
            ...
            <div className="flex justify-between items-center text-[10px] font-black tracking-tight text-[#00246b] dark:text-white leading-tight pt-1.5 border-t border-dashed border-slate-100 dark:border-gray-800/50">
              <span className="text-slate-400 dark:text-gray-500 uppercase tracking-widest text-[8px]">
                {booking.status === 'completed' ? 'Amount Paid' : 'Amount to be paid'}
              </span>
              <span className="text-[12px] font-black text-emerald-600 dark:text-emerald-400">
                ₹{booking.status === 'cancelled' ? 0 : (booking.totalPrice || 0)}
              </span>
            </div>
