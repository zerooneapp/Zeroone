...
const VendorProfile = () => {
   ...
   return (
      <div className="bg-slate-50 dark:bg-gray-950 pb-6 overflow-x-hidden no-scrollbar">
         {/* Header */}
         <header className="px-4 pt-[var(--safe-header-top)] pb-3 fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-50 bg-slate-50/95 dark:bg-gray-950/95 backdrop-blur-xl border-b border-slate-100 dark:border-gray-800/60 shadow-sm">
         ...
         <main className="px-4 pt-[var(--safe-main-top)] max-w-4xl mx-auto">
