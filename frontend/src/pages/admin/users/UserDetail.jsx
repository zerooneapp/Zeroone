            ...
            <div className="lg:col-span-1 space-y-5">
               ...
               <div className="p-5 bg-white dark:bg-gray-900 rounded-2xl border border-slate-200/60 dark:border-gray-800 shadow-sm space-y-4">
                  <div className="flex items-center gap-2 px-1">
                     <TrendingUp size={14} strokeWidth={3} className="text-primary dark:text-white" />
...
const InfoItem = ({ icon: Icon, label, value, highlight }) => (
   <div className="flex items-start gap-3">
      <div className="p-1.5 bg-slate-50 dark:bg-gray-800 rounded-lg text-primary dark:text-white mt-0.5 border border-slate-100 dark:border-gray-700 shadow-sm">
