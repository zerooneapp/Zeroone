...
const VendorVerification = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark text-gray-900 dark:text-white flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        {status === 'pending' ? (
          ...
          >
            ...
            <div className="p-6 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-xl shadow-primary/5 space-y-4">
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm font-black dark:text-white">Application Received</p>
                </div>
              </div>
              <div className="w-full h-px bg-gray-50 dark:bg-gray-800 ml-14" />
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm font-black dark:text-white">Reviewing Documents</p>
                </div>
              </div>
            </div>
