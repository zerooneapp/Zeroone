...
const Favorites = () => {
   ...
   return (
      <div className="min-h-screen bg-slate-50 dark:bg-gray-950 pb-32">
         ...
         <div className="sticky top-0 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-3xl border-b border-slate-200/60 dark:border-gray-800 px-3 pt-[var(--safe-header-top)] pb-3">
