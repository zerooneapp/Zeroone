...
const CheckoutReview = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-gray-950 pb-32 animate-in fade-in duration-500">
      ...
      {/* Confirmation Bar */}
      <div className="fixed bottom-[52px] left-4 right-4 p-3 bg-white/80 dark:bg-gray-950/80 backdrop-blur-2xl border border-slate-200/40 dark:border-gray-800 rounded-2xl z-50 shadow-2xl">
