...
const PaymentMethods = () => {
  ...
  return (
    <div className="h-[100dvh] bg-slate-50 dark:bg-gray-950 flex flex-col overflow-hidden animate-in fade-in duration-500">
      {/* 🛡️ ELITE HEADER */}
      <header className="px-2.5 pt-[var(--safe-header-top)] pb-3 sticky top-0 bg-white/95 dark:bg-gray-950/95 backdrop-blur-xl z-50 border-b border-slate-100 dark:border-gray-800 shadow-sm transition-all">
      ...
      {/* 🚀 ACTION FOOTER */}
      <div className="p-5 pb-[62px] bg-white/80 dark:bg-gray-950/80 backdrop-blur-lg">
         <motion.button
           whileTap={{ scale: 0.95 }}
           onClick={handleAddMethod}
