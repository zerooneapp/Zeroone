...
const ServiceForm = () => {
   ...
   return (
      <div className="min-h-screen bg-background-light dark:bg-gray-950 pb-32">
         <header className="px-4 pt-[var(--safe-header-top)] pb-3 fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-50 bg-background-light/95 dark:bg-gray-950/95 backdrop-blur-xl border-b border-slate-100 dark:border-gray-800 shadow-sm flex items-center gap-3">
            <button
               onClick={() => navigate(-1)}
