...
import {
  ...
  BarChart3, Handshake, LayoutDashboard, Download
} from 'lucide-react';
import {
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-slate-200/60 dark:border-gray-800 shadow-sm overflow-hidden">
            {data.recentVendors.map((vendor) => (
              <div
                ...
                className="p-3.5 px-4.5 border-b border-slate-50 dark:border-gray-800 last:border-0 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-gray-800/50 transition-all group cursor-pointer"
              >
