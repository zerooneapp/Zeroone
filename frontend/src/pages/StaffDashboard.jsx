...
const StaffDashboard = () => {
   ...
   return (
      <div className="min-h-screen bg-slate-50 dark:bg-gray-950 pb-32">
         ...
         <div className="px-4 pt-[var(--safe-header-top)] pb-3 bg-white/80 dark:bg-gray-900/80 fixed top-0 left-0 right-0 z-40 backdrop-blur-3xl border-b border-slate-200/60 dark:border-gray-800">
         ...
         <main className="p-4 space-y-3.5 pt-[var(--safe-main-top)]">
