...
const Notifications = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-gray-950 pb-32">
            ...
            <header className="px-5 pt-[var(--safe-header-top)] pb-4 sticky top-0 bg-white/80 dark:bg-gray-950/80 backdrop-blur-2xl z-50 border-b border-slate-200/60 dark:border-gray-800 shadow-sm">
