...
const PendingVerification = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F3F2F7] dark:bg-gray-950 text-[#1C2C4E] dark:text-white flex flex-col items-center justify-center p-6 text-center relative overflow-hidden font-sans">
                    ...
                    >
                        ...
                        <div className="pt-4 flex flex-col items-center gap-4">
                            ...
                            <button
                                ...
                                className="text-[#1C2C4E]/70 hover:text-[#1C2C4E] dark:text-gray-500 dark:hover:text-white transition-colors flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] mt-4"
                            >
