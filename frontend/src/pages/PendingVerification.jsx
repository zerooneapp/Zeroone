                    ...
                    >
                        ...
                        <div className="pt-4 flex flex-col items-center gap-4">
                            ...
                            <button
                                ...
                                className="text-[#00246b]/70 hover:text-[#00246b] dark:text-gray-500 dark:hover:text-white transition-colors flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] mt-4"
                            >
