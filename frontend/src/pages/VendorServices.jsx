...
const VendorServices = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-950 pb-6">
      <header className="fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-50 px-5 pt-[48px] md:pt-3 pb-3 bg-slate-50/95 dark:bg-gray-950/95 backdrop-blur-xl border-b border-slate-100 dark:border-gray-800/60 shadow-sm">
      ...
      <main className="px-5 pt-[102px] md:pt-[70px]">
