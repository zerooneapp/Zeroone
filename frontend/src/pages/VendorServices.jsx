...
const VendorServices = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-950 pb-6">
      <header className="fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-50 px-5 pt-[var(--safe-header-top)] pb-3 bg-slate-50/95 dark:bg-gray-950/95 backdrop-blur-xl border-b border-slate-100 dark:border-gray-800/60 shadow-sm">
      ...
      <main className="px-5 pt-[calc(var(--safe-header-top)+54px)]">
        ...
        <AnimatePresence mode="wait">
          {services.length === 0 ? (
            ...
            >
              <div className="w-20 h-20 bg-[#00246b]/5 dark:bg-white/5 rounded-[2.5rem] flex items-center justify-center mx-auto text-[#00246b]/30 dark:text-white/30 border border-[#00246b]/10 dark:border-white/10">
                <Scissors size={40} />
              </div>
