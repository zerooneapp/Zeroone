...
const StaffReviews = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white dark:bg-gray-950 p-4 pt-[var(--safe-main-top)] space-y-3">
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 pb-20">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-40 bg-white/95 dark:bg-gray-950/95 backdrop-blur-xl border-b border-slate-100 dark:border-gray-800 px-4 pt-[var(--safe-header-top)] pb-2">
      ...
      <main className="px-4 pt-[var(--safe-main-top)] space-y-2">
        {/* Summary Bar */}
                ...
                <div className="flex flex-col gap-1.5 mt-1.5">
                  ...
                  {review.staffName && (
                    <div className="flex items-center gap-1 mt-0.5">
                      <span className="text-[8px] font-black text-[#00246b] dark:text-gray-300 uppercase tracking-widest border border-[#00246b]/20 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 px-1.5 py-0.5 rounded">
                        Professional: {review.staffName}
                      </span>
                    </div>
                  )}
                </div>
