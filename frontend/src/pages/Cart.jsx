  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-gray-950 pb-32 animate-in slide-in-from-right-4 duration-500">
      ...
      <motion.div
        ...
        className="fixed bottom-[66px] left-4 right-4 bg-slate-900 dark:bg-gray-900 p-2.5 px-5 rounded-3xl shadow-2xl z-50 border border-white/10 backdrop-blur-xl"
      >
