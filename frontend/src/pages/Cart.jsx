...
const Cart = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-gray-950 pb-32 animate-in slide-in-from-right-4 duration-500">
      {/* Header */}
      <div className="px-2.5 pt-[var(--safe-header-top)] pb-3 flex items-center justify-between sticky top-0 bg-background-light/95 dark:bg-gray-950/95 backdrop-blur-xl z-50 border-b border-slate-100 dark:border-gray-800 shadow-sm">
      ...
      {/* Sticky Bottom Bar */}
        <motion.div
          ...
          className="fixed left-4 right-4 bg-[#00246b] dark:bg-[#00246b] py-2 px-5 rounded-2xl shadow-2xl z-50 border border-[#00246b]/20 backdrop-blur-xl"
