...
const VendorReviews = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 pb-20">
      ...
      <main className="px-4 pt-[110px] space-y-3">
        <section className="bg-white dark:bg-gray-900 border border-[#1C2C4E]/10 dark:border-gray-800 rounded-xl p-3 shadow-sm">
          <div className="flex items-center justify-between gap-4">
            <div>
              <p className="text-[9px] font-black text-[#0B1222]/35 dark:text-gray-400 tracking-widest uppercase">
                Average Rating
              </p>
              <div className="flex items-center gap-1.5 mt-0.5">
                <Star size={16} className="text-yellow-400 fill-yellow-400" />
                <span className="text-xl font-black text-[#0B1222] dark:text-white">
            ...
            <div className="text-right">
              ...
              <p className="text-xl font-black text-[#0B1222] dark:text-white mt-0.5">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-[12px] whitespace-nowrap text-[10px] font-black tracking-widest transition-all ${
                selectedService === service
                  ? 'bg-[#00246b] text-white shadow-xl shadow-[#00246b]/20'
                  : 'bg-white dark:bg-gray-900 text-[#0B1222] dark:text-white border border-[#00246b]/10 dark:border-gray-800 shadow-sm'
              }`}
            >
              {service}
            </button>
        ...
        <section className="space-y-2">
          {filteredReviews.length === 0 ? (
            <div className="rounded-xl border border-dashed border-slate-200 dark:border-gray-800 bg-slate-50/60 dark:bg-gray-900/40 p-8 text-center">
              <MessageSquareText size={24} className="mx-auto text-slate-300 dark:text-gray-700" />
            ...
            filteredReviews.map((review) => (
              <div
                key={review._id}
                className="bg-white dark:bg-gray-900 border border-[#00246b]/10 dark:border-gray-800 rounded-xl p-3 shadow-sm space-y-2"
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-2 min-w-0">
                    <div className="w-9 h-9 rounded-xl overflow-hidden bg-slate-100 dark:bg-gray-800 shrink-0">
                      {review.user?.image ? (
                    ...
                    <div className="min-w-0">
                      <h3 className="text-[12px] font-black text-[#0B1222] dark:text-white truncate">
                ...
                {review.comment ? (
                  ...
                  <p className="text-[9px] font-black text-slate-300 dark:text-gray-600 uppercase tracking-widest">
                    No written comment
                  </p>
                )}
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-0.5">
                    {review.services.map((service) => (
                      <span
                        ...
                        className="px-2 py-0.5 rounded-lg bg-[#00246b]/5 dark:bg-white/5 border border-[#00246b]/10 dark:border-gray-800 text-[8px] font-black text-[#0B1222] dark:text-white uppercase tracking-widest"
                      >
                        {service}
                      </span>
                    ))}
