...
const VendorReviews = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 pb-20">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-40 bg-white/95 dark:bg-gray-950/95 backdrop-blur-xl border-b border-slate-100 dark:border-gray-800 px-4 pt-[48px] md:pt-3 pb-2">
      ...
      <main className="px-4 pt-[108px] md:pt-[70px] space-y-2">
        {/* Summary Bar */}
