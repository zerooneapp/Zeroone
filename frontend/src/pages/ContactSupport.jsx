...
const ContactSupport = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F3F2F7] dark:bg-gray-950 font-sans pb-12">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-50 bg-[#F3F2F7]/80 dark:bg-gray-950/80 backdrop-blur-xl border-b border-gray-200 dark:border-gray-800 px-4 pt-[var(--safe-header-top)] pb-3">
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-black text-[#00246b] dark:text-white leading-none">Contact & Support</h1>
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">We're here to help</p>
          </div>
        </div>
      </header>

      <main className="max-w-4xl mx-auto px-4 pt-[var(--safe-main-top)] space-y-4">
        {/* Intro Card */}
        <motion.div 
        ...
        >
          ...
          <h2 className="text-xl font-black text-[#00246b] dark:text-white tracking-tight">How can we help you?</h2>
          ...
          {supportChannels.map((channel, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-black text-[#00246b] dark:text-white uppercase tracking-tight">{channel.title}</h3>
              </div>
              <p className="text-[12px] font-medium text-gray-600 dark:text-gray-400 leading-relaxed pl-12 mb-2">
                {channel.content}
              </p>
              <div className="pl-12">
                <span className="inline-block px-3 py-1 bg-gray-100 dark:bg-gray-800 text-[#00246b] dark:text-white rounded-lg text-[11px] font-bold">
                  {channel.detail}
                </span>
              </div>
            </motion.div>
        ...
        <div className="text-center pt-8 space-y-4">
          <div className="flex items-center justify-center gap-2">
            <span className="text-[10px] font-black text-[#00246b] dark:text-gray-500 uppercase tracking-[0.2em]">ZeroOne Customer Care</span>
          </div>
