...
const StaffHistory = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark pb-32">
      {/* 📱 MOBILE HEADER */}
      <div className="fixed top-0 left-0 right-0 max-w-4xl w-full mx-auto z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-b border-gray-100 dark:border-gray-800 pt-[48px] md:pt-3 px-5 pb-3 transform-gpu">
      ...
      <div className="px-3 pt-[108px] md:pt-[70px] py-4 space-y-4">
